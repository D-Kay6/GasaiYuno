...
namespace GasaiYuno.Listing.Discord.Models
{
    public interface IEndpoint
    {
        ...
        Task<IRestResponse> SendUpdateAsync(ulong botId, int guildCount);
        ...
        /// <param name="guildCount">The amount of servers the bot is in.</param>
        /// <returns>An awaitable <see cref="Task" />.</returns>
        Task<IRestResponse> SendUpdateAsync(ulong botId, int shardCount, int guildCount);
        ...
        /// <param name="guildCount">The amount of servers the bot is in.</param>
        /// <returns>An awaitable <see cref="Task" />.</returns>
        Task<IRestResponse> SendUpdateAsync(ulong botId, int shardCount, int shardId, int guildCount);
    }
}