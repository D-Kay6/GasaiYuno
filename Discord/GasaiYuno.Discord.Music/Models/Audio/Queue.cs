...
public class Queue<T> : IEnumerable<T> where T : LavalinkTrack
{
    ...
    ///     Adds an object.
    /// </summary>
    /// <param name="value">Any object that inherits <see cref="LavalinkTrack" />.</param>
    ...
    /// </summary>
    /// <param name="values">Any object that inherits <typeparamref name="T"/>.</param>
    ...
    /// </summary>
    /// <param name="value">Any object that inherits <see cref="LavaTrack" />.</param>
    ...
    /// </summary>
    /// <returns>First object of type <see cref="LavalinkTrack" />.</returns>
    public T Pop()
    {
        lock (List)
        {
    ...
    ///     Safe way to dequeue an item.
    /// </summary>
    /// <param name="value">First object of type <see cref="LavalinkTrack" />.</param>
    ...
    /// </summary>
    /// <returns>Returns first item of type <see cref="LavalinkTrack" />.</returns>
    public T Peek()
    {
        lock (List)
        {
