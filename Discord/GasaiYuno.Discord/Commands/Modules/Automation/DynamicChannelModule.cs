...
public class DynamicChannelModule : BaseInteractionModule<DynamicChannelModule>
{
    ...
    public async Task DetailsDynamicChannelCommand(
    ...
    public async Task DynamicChannelAddAsync(
        ...
        [Summary(description: "The type of the generated channels.")] AutomationType type)
    {
        ...
        if (await UnitOfWork.DynamicChannels.AnyAsync(x => x.Server == Context.Guild.Id && x.Name == name).ConfigureAwait(false))
        {
        ...
        await UnitOfWork.DynamicChannels.AddAsync(dynamicChannel).ConfigureAwait(false);
    ...
    public async Task DeleteDynamicChannelCommand(
        [Autocomplete(typeof(DynamicChannelAutocompleteHandler))] [Summary(description: "The name of the configuration.")] string name)
    {
        var dynamicChannel = await UnitOfWork.DynamicChannels.GetAsync(Context.Guild.Id, name).ConfigureAwait(false);
        if (dynamicChannel == null)
    ...
    public async Task EditDynamicChannelCommand(
        [Autocomplete(typeof(DynamicChannelAutocompleteHandler))] [Summary(description: "The name of the configuration.")] string name,
    ...
    public async Task AssignDynamicChannelCommand(
        [Autocomplete(typeof(DynamicChannelAutocompleteHandler))] [Summary(description: "The name of the configuration.")] string name,
    ...
    public async Task RemoveDynamicChannelCommand(
        [Autocomplete(typeof(DynamicChannelAutocompleteHandler))] [Summary(description: "The name of the configuration.")] string name,
